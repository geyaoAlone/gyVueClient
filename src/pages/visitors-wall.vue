...
<div>
  <div class="visi_body">
    ...
    <div class="visi_tip">
      <ul>
        <li>整体的布局声明：文字大小12px，边距与填充均为零。fieldset方框的设置：填充与边距都是10px。设置宽度为270px。文字颜色深灰色#333。边框为一象素的蓝色#06c虚线。 legend域标题的设置：文字颜色为蓝色#06c，文字加粗，背景色为白色#fff。 对无序列表ul及列表项li进行相关的一些设置。</li>
        <li>文案1</li>
        <li>文案1</li>
        <li>文案1</li>
        <li>文案1</li>
